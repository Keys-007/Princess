...
from AkenoMusic.modules.play import generate_cover
from AkenoMusic.modules.play import arq
from AkenoMusic.modules.play import cb_admin_check
from AkenoMusic.modules.play import transcode
from AkenoMusic.modules.play import convert_seconds
from AkenoMusic.modules.play import time_to_seconds
from AkenoMusic.modules.play import changeImageSize
from AkenoMusic.config import BOT_NAME as bn
from AkenoMusic.config import DURATION_LIMIT
from AkenoMusic.config import UPDATES_CHANNEL as updateschannel
from AkenoMusic.config import que
from AkenoMusic.function.admins import admins as a
from AkenoMusic.helpers.admins import get_administrators
from AkenoMusic.helpers.channelmusic import get_chat_id
from AkenoMusic.helpers.decorators import authorized_users_only
from AkenoMusic.helpers.filters import command, other_filters
from AkenoMusic.helpers.gets import get_file_name
from AkenoMusic.services.callsmusic import callsmusic, queues
from AkenoMusic.services.callsmusic.callsmusic import client as USER
from AkenoMusic.services.converter.converter import convert
from AkenoMusic.services.downloaders import youtube
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @AkenoMusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
